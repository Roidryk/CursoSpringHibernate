...
List<Libro> librosAñadidos = (List<Libro>)sesion.getAttribute("carrito");
	...
	public String eliminar(HttpSession sesion,Model model) {
		...
		//Se puede gestionar el añadir e eliminar con el controlador usando sesion 
		//el parte de ver libros
	...
	@GetMapping("informe")
	public String informe(@RequestParam String fecha, @RequestParam String fecha2) {

		LocalDateTime ld1= LocalDateTime.of(LocalDate.parse(fecha2).)
