...
public class Mapeador {
	...
	public ClienteDTO clienteEntityToDto(Cliente cliente) {
		...
		return new ClienteDTO(cliente.getUsuario(),cliente.getEmail(),cliente.getUsuario(),cliente.getTelefono());
...
public Libro LibroDtoToEntity(LibroDTO dto) {
	 ...
	 return null;
	//return new Libro(dto.getIsbn(),dto.getAutor(),dto.getTitulo(),dto.getPaginas(),dto.getPrecio());
}
